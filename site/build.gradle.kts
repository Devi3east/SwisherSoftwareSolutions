...
group = "com.example.swishersoftwaresolutions"
...
kotlin {
    configAsKobwebApplication("swishersoftwaresolutions")
    ...
    sourceSets {
        ...
        jsMain.dependencies {
            ...
            implementation("com.github.stevdza-san:KotlinBootstrap:0.1.3")
